classdef RangeSensor < handle
    ...
    properties (SetAccess = protected, GetAccess = public)
        ...
        max_dist = 20; % Max distance of the range measurements
    end
    ...
    methods (Access = public)
        ...
        function detections = getObstacleDetections(obj,q, th, world)
            ...
            for l = 1:obj.n_lines
                ...
                for k = 1:world.n_obstacles
                    % Calcualte the distance to the polygon
                    inPoly = world.obstacles(k).poly.Vertices';
                    [xk, yk, dist_tmp] = obj.getLineDetection(line, inPoly);
